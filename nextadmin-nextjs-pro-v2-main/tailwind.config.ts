...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      // FusionMarkt Design System Extensions
      borderRadius: {
        "fm-sm": "10px",
        "fm-md": "16px",
        "fm-lg": "20px",
      ...
      spacing: {
        ...
        "fm-8": "32px",
        "fm-10": "40px",
        // FusionMarkt Component Sizes
        "fm-input": "40px",
        "fm-button": "40px",
        "fm-toggle": "28px",
        "fm-icon": "18px",
        "fm-thumbnail": "48px",
        // FusionMarkt Preview Sizes
        "fm-preview-web-w": "520px",
        "fm-preview-web-h": "320px",
        "fm-preview-mobile-w": "320px",
        "fm-preview-mobile-h": "560px",
        "fm-preview-wide-w": "520px",
        "fm-preview-wide-h": "220px",
        // Existing spacing
        "11": "2.75rem",
        "13": "3.25rem",
        "14": "3.5rem",
      ...
      boxShadow: {
        // FusionMarkt Shadows
        "fm-card": "0px 1px 3px rgba(0, 0, 0, 0.08), 0px 2px 8px rgba(0, 0, 0, 0.04)",
        "fm-card-hover": "0px 4px 12px rgba(0, 0, 0, 0.1), 0px 2px 6px rgba(0, 0, 0, 0.06)",
        "fm-modal": "0px 20px 40px rgba(0, 0, 0, 0.2), 0px 8px 16px rgba(0, 0, 0, 0.1)",
        "fm-dropdown": "0px 4px 16px rgba(0, 0, 0, 0.12)",
        // Existing shadows
