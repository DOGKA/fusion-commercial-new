      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-stroke bg-white dark:border-dark-3 dark:bg-gray-dark">
          ...
          <div className="p-6 grid grid-cols-2 gap-4">
            ...
            <Link href="/legal" className="flex items-center gap-3 p-4 rounded-lg border border-stroke dark:border-dark-3 hover:border-primary hover:bg-primary/5 transition-colors">
              ...
              <div>
                <p className="font-medium text-dark dark:text-white">Yasal Sayfalar</p>
