...
// Frontend ile birebir aynı default kartlar
const createDefaultCards = (): BannerCard[] => [
  {
    id: `new-${Date.now()}-0`,
    ...
    icon: { type: "preset", presetId: "battery" },
    gradient: createGradientFromPreset("green_cyan"),
    desktopColSpan: 2,
    desktopRowSpan: 2,
    mobileColSpan: 1,
  ...
  },
  {
    ...
    icon: { type: "preset", presetId: "sun" },
    gradient: createGradientFromPreset("orange_red"),
    desktopColSpan: 1,
    desktopRowSpan: 1,
    mobileColSpan: 1,
    mobileRowSpan: 1,
  ...
  },
  {
    ...
    icon: { type: "preset", presetId: "ladder" },
    gradient: createGradientFromPreset("purple_pink"),
    desktopColSpan: 1,
    desktopRowSpan: 1,
    mobileColSpan: 1,
    mobileRowSpan: 1,
  ...
  },
  {
    ...
    icon: { type: "preset", presetId: "glove" },
    gradient: createGradientFromPreset("blue_indigo"),
    desktopColSpan: 2,
    desktopRowSpan: 1,
    mobileColSpan: 1,
    mobileRowSpan: 1,
...
export default function NewBannerPage() {
  ...
  // Add card
  const addCard = () => {
    if (formData.cards.length >= 6) return;
    setFormData((prev) => ({
      ...prev,
  ...
  const handleMediaSelect = (media: any) => {
    ...
    } else if (mediaTarget === "card") {
      // Could add card image support here
    }
      ...
      <FormSection title="Görseller">
        <FormField label="Masaüstü Görsel" hint="Önerilen: 1920x1080">
          {formData.desktopImage ? (
            <div className="relative aspect-video rounded-lg overflow-hidden bg-gray-2 dark:bg-dark-2">
              ...
              <div className="absolute inset-0 bg-black/50 opacity-0 hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                <button
                  ...
                  className="px-3 py-1.5 bg-white text-dark rounded text-sm"
                >
                  Değiştir
                </button>
                <button
            ...
            <button
              onClick={() => openMediaLibrary("desktop")}
              className="w-full aspect-video border-2 border-dashed border-stroke dark:border-dark-3 rounded-lg flex items-center justify-center text-gray-5 hover:border-primary hover:text-primary transition-colors"
            >
              + Görsel Seç
            </button>
          )}
        ...
        <FormField label="Mobil Görsel" hint="Önerilen: 1200x1200">
          {formData.mobileImage ? (
            ...
            <button
              onClick={() => openMediaLibrary("mobile")}
              className="w-[200px] aspect-square border-2 border-dashed border-stroke dark:border-dark-3 rounded-lg flex items-center justify-center text-gray-5 hover:border-primary hover:text-primary transition-colors"
            >
              + Görsel Seç
            </button>
          )}
        ...
        <div className="flex items-center justify-between p-4 bg-gray-1 dark:bg-dark-2 rounded-lg">
          ...
          <button
            ...
            className={`w-12 h-7 rounded-full relative transition-colors ${
              formData.isActive ? "bg-fm-success" : "bg-gray-4"
            }`}
          >
            <span
  ...
  return (
    <>
      <EditorWithPreview
        title="Banner Grid"
        subtitle="Yeni bir banner grid oluşturun"
        backUrl="/banners"
        isNew
