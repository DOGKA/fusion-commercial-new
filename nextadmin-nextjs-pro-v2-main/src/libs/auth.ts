  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        // ADMIN PANEL - Sadece ADMIN ve SUPER_ADMIN giriş yapabilir
        // Middleware'de de kontrol var ama burada da engelleyelim
        if (user.role !== "ADMIN" && user.role !== "SUPER_ADMIN") {
          console.warn(`⛔ Login rejected for ${user.email} - Role: ${user.role}`);
          throw new Error("Yönetici yetkisi gerekli. Sadece admin hesapları giriş yapabilir.");
        }
