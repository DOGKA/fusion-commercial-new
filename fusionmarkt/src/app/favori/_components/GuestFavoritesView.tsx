...
/**
 * Misafir favorileri — `/favori` yüzeyi.
 *
 * Oturumlu kullanıcı buraya hiç düşmez; `page.tsx` onu `/hesabim/favorilerim`e
 * yönlendiriyor. Bu ekran yalnızca giriş yapmamış ziyaretçi için var, çünkü
 * favori eklemek için giriş zorunlu değil ve misafir listesi `localStorage`'da
 * duruyor (bkz. `FavoritesContext`). Hesap kabuğu oturum ister, dolayısıyla
 * misafire gösterilemez — iki ekranın birden durmasının sebebi bu.
 */
...
export default function GuestFavoritesView() {
          ...
          <div className="relative mb-6 sm:mb-8 lg:mb-12">
            ...
            <div className="relative text-center">
              ...
              <p className="text-foreground-muted dark:text-white/40 text-xs sm:text-sm">
                {itemCount > 0 
                  ? `Beğendiğiniz ${itemCount} ürün var`
