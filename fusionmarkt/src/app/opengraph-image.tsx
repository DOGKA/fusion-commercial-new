 ...
 * Slider görselini arka plan olarak kullanarak OG image oluşturur
 */
...
export default async function Image() {
  // İlk aktif slider'ı veritabanından çek
  let sliderImage: string | null = null;
  let sliderTitle: string | null = null;
  let sliderSubtitle: string | null = null;
  ...
  try {
    ...
    console.error("Error fetching slider for OG image:", error);
  }
    ...
    (
      ...
      >
        ...
        >
          ...
          {/* Slider Title or Default Tagline */}
          <div
            style={{
              fontSize: 36,
              fontWeight: 700,
          ...
          >
            {sliderTitle || "Taşınabilir Güç Kaynakları"}
          </div>
          ...
          {/* Default tagline if no slider subtitle */}
          {!sliderSubtitle && (
            <div
              style={{
                fontSize: 26,
          ...
          >
            {["IEETek", "Traffi", "Telescopics"].map((brand) => (
              <div
                key={brand}
                style={{
                  fontSize: 18,
