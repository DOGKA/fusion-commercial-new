...
export const TURKEY_CITIES: Record<string, string[]> = {
  ...
  "Sivas": ["Akıncılar", "Altınyayla", "Divriği", "Doğanşar", "Gemerek", "Gölova", "Güün", "Hafik", "İmranlı", "Kangal", "Koyulhisar", "Merkez", "Suşehri", "Şarkışla", "Ulaş", "Yıldızeli", "Zara"],
...
export const CITIES = Object.keys(TURKEY_CITIES).sort();
