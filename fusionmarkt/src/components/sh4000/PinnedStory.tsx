...
const scenes: Scene[] = [
  ...
  },
  {
    id: 'mobility',
    label: 'TAŞIMA',
    imageLabel: 'Zırhlı Tekerlekler',
    imageSrc: '/sh4000/wheel-800x800.png',
    badge: 'TAŞINABİLİRLİK',
    title: '65kg',
    highlight: 'Mobil',
    description: 'Zırhlı tekerlekler ve teleskopik çekme kolu ile 65kg ağırlığa rağmen kolay taşınabilirlik.',
    specs: [
      { label: 'Ağırlık', value: '65kg' },
      { label: 'Tekerlek', value: 'Zırhlı' },
